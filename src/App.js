      ...
      Quagga.init({
        ...
        debug: {
          ...
          Quagga.onDetected(function callback(data){
            data.codeResult ? console.log(data.codeResult.code) : console.log('nope')
  ...
  render (){
    console.log(this.state)
      ...
      <div className="App">
        ...
        <button onClick={this.initiateBarcodeDetection}>
            Start
        </button>
        <button onClick={this.stopBarcodeDetection}>
            Stop
        </button>
